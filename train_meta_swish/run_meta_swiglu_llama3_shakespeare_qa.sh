...
: ${MODEL_PATH:="/vepfs/group04/beijing-public/models/llama_3.1_8b_instruct"}
: ${TOKENIZER_PATH:="/vepfs/group04/beijing-public/models/llama_3.1_8b_instruct"}
: ${DATASET:="Shakespeare_qa"}
: ${OUTPUT_PATH:="/vepfs/group04/user/jl/results/metaSwiglu/metaSwiGLU_llama3_8b_sft_Shakespeare_qa_lr1e-4_0908"}
: ${TEMPLATE:="llama3"}
: ${LR:=1e-4}
: ${LR_TYPE:="cosine"}
