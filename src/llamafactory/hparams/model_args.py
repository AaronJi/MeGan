...
class ModelArguments(QuantizationArguments, ProcessorArguments, ExportArguments, VllmArguments):
    ...
    meta_swishglu_attn_head_num: Optional[int] = field(
        default=4,
        metadata={"help": "The number of attention heads in Meta SwishGLU."},
    )
    meta_swishglu_l2_lambda: float = field(
        default=0.000,
        metadata={"help": "meta_swishglu_l2_lambda for regularization"},
    )
    meta_swishglu_mlp_bias: Optional[int] = field(
        default=1,
        metadata={"help": "Whether or not to use bias in meta Beta MLP."},
    )
