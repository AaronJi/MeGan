...
class FinetuningArguments(
    ...
    finetuning_type: Literal["lora", "freeze", "full", "meta_swiglu_simple", "meta_swiglu", "meta_swiglu_full"] = field(
        default="lora",
    ...
    meta_l2_lambda: float = field(
        default=0.000,
        metadata={"help": "meta_swishglu_l2_lambda for regularization"},
    )
    ...
    def __post_init__(self):
        ...
        assert self.finetuning_type in ["lora", "freeze", "full", "meta_swiglu_simple", "meta_swiglu", "meta_swiglu_full"], "Invalid fine-tuning method."
